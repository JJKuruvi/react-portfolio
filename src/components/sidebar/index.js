...
import { faEnvelope, faHouseChimney, faUser } from '@fortawesome/free-solid-svg-icons'
...
const Sidebar = () => (
    <div className='nav-bar'>
        ...
        <ul>
            <li>
                <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/joji-kuruvila/">
